...
// or equal to 1 and rejects t o "sad" if the value is less than 1
// Example:
...
const amIYourFather = (Luke) => {
    return new Promise((resolve, reject) => {
        if( Luke === "Luke") {
            return resolve("Yes. Luke, I am your father.")
        } else if( Luke !== "Luke") {
            return reject("Not your dad.")
        }
    })
 };
...
const myNameIs = () => {
    return new Promise((resolve, reject) => {
       return resolve((name) => {return `My name is ${name}`});
